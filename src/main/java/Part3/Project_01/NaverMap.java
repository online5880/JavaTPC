...
public class NaverMap implements ActionListener{
    Project01_6 naverMap;

    public NaverMap(Project01_6 naverMap) {
        this.naverMap = naverMap;
    }

    @Override
    public void actionPerformed(ActionEvent e) {
        String clientId = "py3bgu29ae";
        String clientSecret = "EMjrUK2LD475NCbZuNTmzvY4TeD2uOSqLvMJUX0O";
        AddressVO vo=null;
        try {
    ...
    public void map_service(AddressVO vo) {
        ...
        try {
            String pos=URLEncoder.encode(vo.getX() + " " + vo.getY(), StandardCharsets.UTF_8);
            ...
            HttpURLConnection con = (HttpURLConnection)url.openConnection();
            con.setRequestMethod("GET");
            con.setRequestProperty("X-NCP-APIGW-API-KEY-ID", "py3bgu29ae");
            con.setRequestProperty("X-NCP-APIGW-API-KEY", "EMjrUK2LD475NCbZuNTmzvY4TeD2uOSqLvMJUX0O");
            int responseCode = con.getResponseCode();
            BufferedReader br;
